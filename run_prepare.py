...
#: Diretório dos dicionários do IRaMuTeQ (lexique, key, expression). Não são
#: redistribuídos com este repositório. Defina o caminho pela variável de
#: ambiente LABIIALEX_DICT ou passe --dictionaries. O fallback relativo só serve
#: quando os dicionários estão em ../extracted/internal/dictionaries.
_FALLBACK_DICT_DIR = (
...
DEFAULT_DICT_DIR = Path(os.environ.get("LABIIALEX_DICT", str(_FALLBACK_DICT_DIR)))
